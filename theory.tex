...
\begin{figure}[h]
    ...
    \caption[The initial $R_{sq}$ of Gaussian initialized networks.]{
        ...
        $10000$. The network is fed with 1000 randomly generated data point drawn from 
        zero-mean white Gaussian distribution with standard deviation equals to $0.1$.
        The VNI $R_{sq}$ are evaluated according to the definition in \eqref{rsq_def}.
...
\begin{figure}[h]
    ...
    \begin{subfigure}{\myWidth}
      \centering
      \caption{Network depth $L\in[1, 500]$}
      \includegraphics[width=1.0\linewidth]{500_r2_layer_rsq}
      \label{fig:repr_residual_b}
    \end{subfigure}%
    \caption[The initial $R_{sq}$ of residual networks.]{}
